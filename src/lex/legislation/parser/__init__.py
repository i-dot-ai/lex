...
This repository has been been inspired by that codebase, but has been modified to focus more on correct text extraction. The graph structure is not used, while a custom text extraction parser is created for vector search.
