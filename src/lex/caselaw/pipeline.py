    ...
    for court in court_types:
        for year in sorted(years):
            ...
            try:
                ...
                for soup, case_url in scraper.load_content(years=[year], limit=limit, types=[court]):
                    ...
                    try:
                        ...
                        is_pdf_fallback = "pdf" in error_msg.lower() or "no body found" in error_msg.lower()
