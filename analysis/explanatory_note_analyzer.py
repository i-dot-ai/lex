...
class ExplanatoryNoteAnalyzer(BaseAnalyzer):
    ...
    def get_explanatory_note_coverage_by_year(self) -> Dict[int, Dict[str, int]]:
        ...
        # Group by year
        stats_by_year = defaultdict(
            lambda: {"total_attempts": 0, "found": 0, "not_found": 0, "parse_errors": 0}
        )
    ...
    def print_report(self):
        ...
        for year in sorted(by_year.keys()):
            ...
            print(
                f"{year:<6} {stats['total_attempts']:<10} {stats['found']:<8} "
        ...
        for leg_type in sorted(by_type.keys()):
            ...
            print(
                f"{leg_type:<10} {stats['total_attempts']:<10} {stats['found']:<8} "
                f"{stats['coverage_rate']:<12.1f} {stats['not_found']:<10}"
            )
